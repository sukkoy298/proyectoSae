...
<div class="container mt-5">
    ...
    <form action="../controller/proyectControl.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="programador" name="programador" value="<?php echo $programador; ?>" pattern="[A-Za-z\s,:]+" title="solo caracteres alfabeticos" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="requisitos" name="requisitos" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚüÜ\s,.;:'*?-]+" title="Solo se permiten comas, puntos, dos puntos, espacios, acentos, apóstrofes, puntos y comas, asteriscos, guiones, mayúsculas y ñ" required><?php echo $requisitos; ?></textarea>
        </div>
