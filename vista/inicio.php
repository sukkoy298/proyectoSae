            ...
            <div class="feature-box">
                ...
                <div class="feature-box-info">
                    ...
                    <p>para Evaluación y Control de Estudio, adaptado a exigencias del MPPE; también para <br>
                        <strong>Escuelas Técnicas. Disponible para Régimen Regular y Adultos.</strong>
                    </p>
                </div>
            </div>
        </div>
...
<div class="container ">
    <div class="row mt-4 text-center">
        <div>
            <button type="button" class="btn btn-success"><a class="text-decoration-none text-white" href="vista/register.php">ir a Formulario</a></button>
        </div>
    </div>
</div>
