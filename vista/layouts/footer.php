        ...
        <div class="row">
            <div class="col-lg-3 mb-3">
                <a class="d-inline-flex align-items-center mb-2 text-body-emphasis text-decoration-none" href="/"
                    ...
                    <img src="vista/imagenes/logo_h.png" width="150px" height="32" class="d-block me-2"
                ...
                <ul class="list-unstyled small text-white">
                    <li class="mb-2">Todos los derechos reservados para carlos y rafael que con mucho esfuerzo hicieron
                        este sistema.</li>
                    ...
                    <li class="mb-2">Codigo Fuente <a href="https://github.com/sukkoy298/proyectoSae" target="_blank"
                            rel="license noopener">Codigo.</a></li>
                </ul>
            </div>
        </div>
</footer>
